...
//     echo '<br>PLUGIN-PATH: '.$plugin_dir;
//     echo '<br>ASSET-PATH:'.$asset_dir;
//     echo '<br>IMAGE-GENERATOR-PATH:'.$image_generator;

//     echo '<br>'.$asset_dir.'/images/waveform-detail-'.$waveform_detail.'.png';
//     echo '<br>'.$asset_dir.'/fonts/'.$_GET['tagline_font'].'.ttf';
