<?php
	...
	// $tagline_font  	 	= (string) isset($_GET['tagline_font']) ? $asset_dir.'/fonts/'.$_GET['tagline_font'].'.ttf' : $asset_dir.'/fonts/roboto-regular.ttf';
	...
	// $title_font  	 	= (string) isset($_GET['title_font']) ? $asset_dir.'/fonts/'.$_GET['title_font'].'.ttf' : $asset_dir.'/fonts/roboto-regular.ttf';
	...
	// $text_font 	 	 	= (string) isset($_GET['text_font']) ? $asset_dir.'/fonts/'.$_GET['text_font'].'.ttf' : $asset_dir.'/fonts/roboto-regular.ttf';
